...
export class CommercesTableDataSource extends DataSource<CommercesTableItem> {
   ...
   */
  connect(): Observable<CommercesTableItem[]> {
   ...
   */
  private getPagedData(data: CommercesTableItem[]): CommercesTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: CommercesTableItem[]): CommercesTableItem[] {
